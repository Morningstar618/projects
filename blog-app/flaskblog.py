...
# This is the configuration for the database. The SQLALCHEMY_DATABASE_URI is the location of the database.
app.config.from_object(Config)
# This initializes the database with the app.
db.init_app(app)
# This is the bcrypt object that is used to hash passwords.
bcrypt = Bcrypt(app)
...
# This is the login manager that is used to manage the user sessions.
...
def send_reset_email(user):
    ...
    msg = Message("Password Reset Request", sender="noreply@aj2000.com", recipients=[user.email])
...
if __name__ == "__main__":
    # This creates the database tables. This should only be run once to create the tables.
